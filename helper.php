...
//		                            die(__FILE__ .' '. __LINE__ );
	 ...
	 *
	 * @param   string   $var_name     Имя переменной, которая будет использоваться в форме фильтрации etc/
	 *                                 "custom_f_29" The name of the variable which will be used in the filtering form
